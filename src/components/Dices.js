...
function Dices() {
  ...
  const [numberFieldsLeftDownFreeUp, setnumberFieldsLeftDownFreeUp] =
    useState(39);
  ...
  useEffect(() => {
    if (numberFieldsLeftDownFreeUp === 0 && initialCounterValue === 1) {
      setthrowMuted(true);
    }
    ...
    <div>
      {engGameMessage && (
        <div className="endGame">
          ...
          <button onClick={() => window.location.reload()} className="ok_btn">
            <b>Play Agian</b>
          </button>
        </div>
      )}
      ...
      {dicealertMessageOn && (
        <div className="diceAlert">
          {" "}
          <h2>Must select 5 dices!</h2>
          <br></br>
          <button onClick={diceAlert} className="ok_btn">
            Ok
          </button>
        </div>
      )}
      ...
      <button
        ...
        className={
          dicealertMessageOn || engGameMessage
            ? "freezeBackground rules_btn"
            : "rules_btn"
        }
      >
        <b>Rules</b>
      ...
      {showRules && (
        <div className="popuptext">
          <button onClick={displayRules} className="close_btn">
            <b>Close</b>
          </button>

          <h2 className="rulesTitle">Game of Yamb Rules</h2>
          <h3>Column rules:</h3>
          *Roll dices and keep those you liked*
          <p>
            
            1. "Down" column can be entered from top to bottom.
            <br></br>
            2. "Free" column can be entered randomly.
            <br></br>
            3. "Up" column can be entered from the bottom up.
            <br></br>
            4. "Call" column can be entered randomly, each cell must be called
            after first throw (right mouse click or hold field for touch screen).
            <br></br>
            5. "Hand" column can be entered random only after first throw.
          </p>

          <h3>Values:</h3>
          <p>
            1. "Three": Three of a kind. (ex. 3,3,3)
            <br></br>
            2. "Straight": Five dices arranged as a scale. (ex. 1,2,3,4,5 or
            2,3,4,5,6)
            <br></br>
            ...
            <br></br>
            5. "Yamb": Five of a kind. (ex. 6,6,6,6,6)
          </p>

          <h3>Calculations:</h3>
          <p>
            1. Each column's (1-6) sum greater than 59pts receives bonus of
            30pts.
            <br></br>
            2. Difference between Max and Min multiplies by value of "1".
            <br></br>
            3. "Three" gets bonus of 20pts on top of sum of all dices (ex. 6,6,6
            gives 38pts).
            <br></br>
            4. "Straight" won in one throw wins 66pts, second throw 56pts, third
            throw 46pts.
            <br></br>
            5. "Full" gets bonus of 30pts on top of sum of all dices (ex.
            6,6,6,5,5 gives 58pts).
            <br></br>
            6. "Poker" gets bonus of 40pts on top of sum of all dices (ex.
            6,6,6,6 gives 64pts).
            <br></br>
            7. "Yamb" gets bonus of 50pts on top of sum of all dices (ex.
            6,6,6,6,6 gives 80pts).
          </p>
        </div>
      )}
      ...
      <div
        className={
          dicealertMessageOn || engGameMessage
            ? "App grid-container freezeBackground"
            : showRules
            ? "App grid-container bluredBackground"
            : "App grid-container"
        }
      >
        ...
        <div style={{fontSize: '10px'}}> Icons made by <a href="https://www.flaticon.com/authors/bearicons" title="bearicons"> bearicons </a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com'</a></div>
          <i>by Maxa</i>
        </div>
        ...
        <Calculations
          ...
          setnumberFieldsLeftDownFreeUp={setnumberFieldsLeftDownFreeUp}
          setnumberFieldsLeftCallHand={setnumberFieldsLeftCallHand}
          numberFieldsLeftDownFreeUp={numberFieldsLeftDownFreeUp}
          numberFieldsLeftCallHand={numberFieldsLeftCallHand}
          diceAlert={diceAlert}
          makeThworActive={makeThworActive}
          setgetFinalResult={setgetFinalResult}
        />

        <h2 className={throwDisplayRed ? "countThrow turnRed" : "countThrow"}>
          {throwCounter}
        </h2>
        ...
        <div className="dicesThrow">
          <div
            onClick={throwDices}
            className={trhowMuted ? "muteDice throwBox" : "throwBox"}
          >
            <b>Throw Dices</b>
          </div>
          <div
            id="throw1"
            onClick={keepDice1}
            className={!isMuted1 ? "thrownDice1" : "muteDice thrownDice1"}
          >
            {thrownDice1}
          </div>
          <div
            id="throw2"
            onClick={keepDice2}
            className={!isMuted2 ? "thrownDice2" : "muteDice thrownDice2"}
          >
            {thrownDice2}
          </div>
          <div
            id="throw3"
            onClick={keepDice3}
            className={!isMuted3 ? "thrownDice3" : "muteDice thrownDice3"}
          >
            {thrownDice3}
          </div>
          <div
            id="throw4"
            onClick={keepDice4}
            className={!isMuted4 ? "thrownDice4" : "muteDice thrownDice4"}
          >
            {thrownDice4}
          </div>
          <div
            id="throw5"
            onClick={keepDice5}
            className={!isMuted5 ? "thrownDice5" : "muteDice thrownDice5"}
          >
            {thrownDice5}
          </div>
          <div
            id="throw6"
            onClick={keepDice6}
            className={!isMuted6 ? "thrownDice6" : "muteDice thrownDice6"}
          >
            {thrownDice6}
          </div>
        </div>
        <div className="dicesKeep">
          ...
          <div
            id="keep1"
            onClick={returnDice1}
            className={isMuted1 ? "keptDice1" : "muteDice keptDice1"}
          >
            {keptDice1}
          </div>
          <div
            id="keep2"
            onClick={returnDice2}
            className={isMuted2 ? "keptDice2" : "muteDice keptDice2"}
          >
            {keptDice2}
          </div>
          <div
            id="keep3"
            onClick={returnDice3}
            className={isMuted3 ? "keptDice3" : "muteDice keptDice3"}
          >
            {keptDice3}
          </div>
          <div
            id="keep4"
            onClick={returnDice4}
            className={isMuted4 ? "keptDice4" : "muteDice keptDice4"}
          >
            {keptDice4}
          </div>
          <div
            id="keep5"
            onClick={returnDice5}
            className={isMuted5 ? "keptDice5" : "muteDice keptDice5"}
          >
            {keptDice5}
          </div>
          <div
            id="keep6"
            onClick={returnDice6}
            className={isMuted6 ? "keptDice6" : "muteDice keptDice6"}
          >
            {keptDice6}
          </div>
        </div>
